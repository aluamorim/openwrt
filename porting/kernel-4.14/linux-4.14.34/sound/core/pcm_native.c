...
#include <linux/sched/signal.h> // ALU: 
...
////////////////////////////////////////////////////////////////////////////////
// ALU: redefinition of snd_pcm_nmap_data_fault
...
static int alu_snd_pcm_mmap_data_fault(struct vm_fault *vmf)
{

	struct vm_area_struct *area = vmf->vma;
	snd_pcm_mmap_data_fault(area, vmf);
}
...
static const struct vm_operations_struct snd_pcm_vm_ops_data_fault = {
	...
	.close =	snd_pcm_mmap_data_close,
	/*.fault =	snd_pcm_mmap_data_fault,*/
	.fault =	alu_snd_pcm_mmap_data_fault, /* ALU: */
};
// ALU: redefinition of snd_pcm_nmap_data_fault
////////////////////////////////////////////////////////////////////////////////
